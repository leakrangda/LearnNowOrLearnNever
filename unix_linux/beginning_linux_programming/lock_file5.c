...
int main(){
	...
	/* The remainder of the program specifies different regions of the file
	 * and tries different locking operation on them:
	 */
	...
	if(res == -1)
		...
		printf("Process %d - obtained lock regiont\n", getpid());
